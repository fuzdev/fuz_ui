import"../chunks/DsnmJJEf.js";import{p as F,c as G,f as d,s as r,a as f,d as C,b as a,n as e,r as P,i as J,j as T,u as x}from"../chunks/C4lRXgeC.js";import{r as W,D as y}from"../chunks/4GWAt-DL.js";import{C as _}from"../chunks/DqqP-Sbl.js";import{g as K}from"../chunks/C9pYI1VL.js";import{C as $}from"../chunks/DuImEHzo.js";import{T as Q}from"../chunks/C51gHK8j.js";import{T as m,a as g}from"../chunks/CGumX7R1.js";var U=d("just<br/> a card",1),V=d("custom<br/> icon",1),X=d("<!> <!> <!>",1),Z=d("a<br/> link",1),rr=d("<!> <!> <!>",1),tr=d("href is<br/> selected",1),er=d("<!> <!> <!>",1),or=d("custom<br/> tag",1),ar=d("<!> <!> <!>",1),nr=d("align<br/> icon right",1),sr=d("<!> <!> <!>",1),dr=d("align<br/> icon above",1),ir=d("align<br/> icon below",1),lr=d("<section><aside>⚠️ This API is unfinished and will likely change.</aside></section> <section><!> <!> <!></section> <!> <!> <!> <!> <!> <section><!> <!></section> <section><!> <!></section>",1);function br(z,B){F(B,!0);const D=K("Card");Q(z,{get tome(){return D},children:(N,_r)=>{var A=lr(),p=r(f(A),2),k=C(p);_(k,{content:"import Card from '@fuzdev/fuz_ui/Card.svelte';",lang:"ts"});var w=r(k,2);_(w,{content:`<Card>
  just<br />
  a card

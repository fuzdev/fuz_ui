...
</${t(w)}>`);Dt(g,{get content(){return t(v)}})}y(6),i(b),n(T,d)},$$slots:{default:!0}})},$$slots:{default:!0}})}),n(m,l),xt()}var go=$("<!> <!> <!> <!> <!> <!> <!> <!> <section><aside><p>todo: demonstrate using <code>contextmenu_attachment</code> to avoid the wrapper element</p></aside> <aside><p>todo: for mobile, probably change to a drawer-from-bottom design</p></aside></section>",1);function jo(m,e){ft(e,!0);const P=Ae("Contextmenu");Nt.set(),Oe(m,{get tome(){return P},children:(w,l)=>{var a=go(),s=E(a);fn(s,{});var r=o(s,2);Xn(r,{});var x=o(r,2);xo(x,{});var O=o(x,2);io(O,{});var T=o(O,2);ho(T,{});var _=o(T,2);ao(_,{});var d=o(_,2);Wn(d,{});var f=o(d,2);$n(f),y(2),n(w,a)},$$slots:{default:!0}}),xt()}export{jo as component};

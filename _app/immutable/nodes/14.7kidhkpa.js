import"../chunks/DsnmJJEf.js";import{p as lt,k as $t,f as N,a as o,b as ct,aG as te,bm as Tt,bn as ae,s as e,_ as F,J as t,Z as et,bp as Xt,d as s,r as a,aF as ee,c as y,K as P,t as vt,au as Y,ax as k,e as ft,M as Se,aB as Pe,bq as Ie}from"../chunks/3b09WQdB.js";import{T as Ee}from"../chunks/gYP6Xhv1.js";import{t as Oe}from"../chunks/CiJsQovz.js";import{c as Ft}from"../chunks/DWDjIc8L.js";import{C as Dt}from"../chunks/V4YjCdjA.js";import{M as Bt}from"../chunks/Ccrg89gb.js";import{T as Pt,a as It}from"../chunks/WCSSUfHE.js";import{D as St}from"../chunks/CtPmOvbp.js";import{h as Qt,a as ge,S as xe,s as Lt,r as Rt,g as se,i as it,j as Ae,f as be}from"../chunks/DSAfUJfM.js";import{e as ze,t as Ht,a as re}from"../chunks/CG13NUJW.js";import{p as rt,r as ye,i as at}from"../chunks/ntNJAiYm.js";import{c as De,C as jt,a as $e,b as Fe,d as ie}from"../chunks/D8GJNC20.js";import{a as Ne,b as Re,c as Le,d as qe,e as Ue,f as Me,l as He,t as Be,s as Xe,g as We,h as Ge,i as je,j as Ve,k as Ye,C as le,m as nt,n as Ze,o as Ke,p as Je,q as ne,r as Qe}from"../chunks/D3ajge8N.js";import{D as we,b as ce}from"../chunks/CzrSn2rP.js";import{a as de,b as ue,c as Kt}from"../chunks/C7XMjkLF.js";import{c as tn}from"../chunks/CTitCiop.js";import{s as zt}from"../chunks/V2q5a4YM.js";import{e as Wt}from"../chunks/C6JsnBX5.js";import{c as en,s as nn}from"../chunks/DfIpPbHs.js";import{S as on}from"../chunks/Cwd82th4.js";import{G as an}from"../chunks/DQ8xwMUj.js";import{o as sn}from"../chunks/5penOX5b.js";import{b as oe}from"../chunks/DtsEawG1.js";import{S as me}from"../chunks/DKCjQ3ju.js";import{a as rn}from"../chunks/B7oo0W7b.js";import{d as ln}from"../chunks/COpzMoZb.js";import{C as cn,T as dn}from"../chunks/3GTz0tH_.js";import{D as un,a as mn}from"../chunks/CRPY83KX.js";import{r as vn}from"../chunks/o0c3_oV1.js";var _n=new Set(["$$slots","$$events","$$legacy","tag","entries","children"]);function yt(v,n){lt(n,!0);const d=rt(n,"tag",3,"span"),C=ye(n,_n);var _=$t(),r=N(_);ze(r,d,!1,(i,l)=>{Qt(i,()=>De(n.entries)),ge(i,()=>({...C,[xe]:{display:"contents"}}));var c=$t(),h=N(c);Lt(h,()=>n.children),o(l,c)}),o(v,_),ct()}var pn=y('<div class="contextmenu-root svelte-1472w04" role="group"><!></div>'),hn=y("<!> <!>",1);function fn(v,n){lt(n,!0);const d=rt(n,"contextmenu",19,()=>new jt),C=rt(n,"longpress_move_tolerance",3,Ne),_=rt(n,"longpress_duration",3,Re),r=rt(n,"bypass_with_tap_then_longpress",3,!0),i=rt(n,"bypass_window",3,Le),l=rt(n,"bypass_move_tolerance",3,qe),c=rt(n,"open_offset_x",3,Ue),h=rt(n,"open_offset_y",3,Me),w=rt(n,"scoped",3,!1),m=rt(n,"link_entry",3,He),f=rt(n,"text_entry",3,Be),p=rt(n,"separator_entry",3,Xe);$e.set(()=>d());let x=et(void 0),b=0,u=0,g=null,R=!1;const Z=new je,H=new Ge,X=()=>{document.body.classList.add("contextmenu-pending")},B=()=>{document.body.classList.remove("contextmenu-pending")},I=()=>{R=!1,g!==null&&(clearTimeout(g),g=null),B()},E=()=>{I(),Z.reset()},O=P(()=>({open_offset_x:c(),open_offset_y:h(),link_enabled:m()!==null,text_enabled:f()!==null,separator_enabled:p()!==null})),M=$=>{if(!Z.consume()){if(R){if(t(x)?.contains($.target))return;E(),zt($);return}Ve($,d(),t(x),H,t(O))&&E()}},D=$=>{R=!1,H.touchstart();const{touches:L,target:G}=$;if(d().opened||L.length!==1||!Ye(G,$.shiftKey)){E();return}const{clientX:J,clientY:ot}=L[0];r()&&Z.track(J,ot,i(),l())||(b=J,u=ot,X(),g!==null&&I(),g=setTimeout(()=>{R=!0,B(),Fe(G,b+c(),u+h(),d(),t(O))&&H.opened()},_()))},U=$=>{if(g===null||d().opened)return;const{touches:L}=$;if(L.length!==1)return;const{clientX:G,clientY:J}=L[0];if(Math.hypot(G-b,J-u)>C()){I();return}$.preventDefault()},A=$=>{H.touchend($),g!==null&&I(),Z.consume()},S=()=>{H.reset(),E()},z=$=>{const L={passive:!0,capture:!0},G={passive:!1,capture:!0},J=Xt($,"touchstart",D,L),ot=Xt($,"touchmove",U,G),dt=Xt($,"touchend",A,G),q=Xt($,"touchcancel",S,L);return()=>{J(),ot(),dt(),q()}};var W=hn();Tt("contextmenu",ae,function(...$){(w()?void 0:M)?.apply(this,$)}),Qt(ae,()=>w()?void 0:z);var K=N(W);{var T=$=>{var L=pn(),G=s(L);Lt(G,()=>n.children),a(L),Qt(L,()=>z),ee("contextmenu",L,M),o($,L)},V=$=>{var L=$t(),G=N(L);Lt(G,()=>n.children),o($,L)};at(K,$=>{w()?$(T):$(V,-1)})}var Q=e(K,2);We(Q,{get contextmenu(){return d()},get open_guard(){return H},get link_entry(){return m()},get text_entry(){return f()},get separator_entry(){return p()},get el(){return t(x)},set el($){F(x,$)}}),o(v,W),ct()}te(["contextmenu"]);const Et=tn(()=>new gn("standard"));class gn{#t=et();get variant(){return t(this.#t)}set variant(n){F(this.#t,n)}#e=P(()=>this.variant==="standard"?le:fn);get component(){return t(this.#e)}set component(n){F(this.#e,n)}#n=P(()=>this.component===le?"ContextmenuRoot":"ContextmenuRootForSafariCompatibility");get name(){return t(this.#n)}set name(n){F(this.#n,n)}constructor(n="standard"){this.variant=n}}var xn=y('<fieldset><legend><h4>Selected root component:</h4></legend> <label class="row"><input type="radio"/> <div>standard <!></div></label> <label class="row"><input type="radio"/> <div>iOS compat <!></div></label></fieldset>');function Ce(v,n){lt(n,!0);const d=[],C=Et.get();var _=xn(),r=e(s(_),2),i=s(r);Rt(i),i.value=i.__value="standard";var l=e(i,2),c=e(s(l));St(c,{name:"ContextmenuRoot"}),a(l),a(r);var h=e(r,2),w=s(h);Rt(w),w.value=w.__value="compat";var m=e(w,2),f=e(s(m));St(f,{name:"ContextmenuRootForSafariCompatibility"}),a(m),a(h),a(_),de(d,[],i,()=>C.variant,p=>C.variant=p),de(d,[],w,()=>C.variant,p=>C.variant=p),o(v,_),ct()}var bn=y('<p class="panel p_md">alert B -- also inherits A</p>'),yn=y('<div class="panel p_md mb_lg"><p>alert A -- rightclick or longpress here to open the contextmenu</p> <!></div>'),$n=y("<code>navigator.vibrate</code>"),wn=y(`<!> <p>Fuz provides a customizable contextmenu that overrides the system contextmenu to provide helpful
		...
		devices, it searches the DOM tree for behaviors defined with <!> starting from the target element up to the root. If any
		behaviors are found, the Fuz contextmenu opens, showing all contextually available actions. If
		no behaviors are found, the default system contextmenu opens.</p> <p>Here's a <code> </code> with a <!> inside
		...
		managing complexity.</p> <h4>Mouse and keyboard:</h4> <ul><li>rightclick opens the Fuz contextmenu and not the system contextmenu (minus current exceptions
			...
			Fuz contextmenu</li> <li>opening the contextmenu attempts haptic feedback with <!></li></ul> <!>`,1);function Cn(v,n){lt(n,!0);const d=Et.get(),C=P(()=>d.component),_=P(()=>d.name);Pt(v,{children:(r,i)=>{var l=wn(),c=N(l);It(c,{text:"Introduction"});var h=e(c,2),w=e(s(h));Bt(w,{path:"Web/API/Element/contextmenu_event"}),k(3),a(h);var m=e(h,2),f=e(s(m));St(f,{name:"ContextmenuRoot"});var p=e(f,2);St(p,{name:"Contextmenu"}),k(),a(m);var x=e(m,2),b=e(s(x)),u=s(b,!0);a(b);var g=e(b,2);St(g,{name:"Contextmenu"});var R=e(g,2);St(R,{name:"Contextmenu"}),k(),a(x);var Z=e(x,2);Ft(Z,()=>t(C),(D,U)=>{U(D,{scoped:!0,children:(A,S)=>{yt(A,{entries:W=>{nt(W,{run:()=>alert("alert A"),children:(K,T)=>{k();var V=Y("alert A");o(K,V)},$$slots:{default:!0}})},children:(W,K)=>{var T=yn(),V=e(s(T),2);yt(V,{entries:$=>{nt($,{run:()=>alert("alert B"),children:(L,G)=>{k();var J=Y("alert B");o(L,J)},$$slots:{default:!0}})},children:($,L)=>{var G=bn();o($,G)},$$slots:{entries:!0,default:!0}}),a(T),o(W,T)},$$slots:{entries:!0,default:!0}})},$$slots:{default:!0}})});var H=e(Z,2);we(H,{summary:U=>{k();var A=Y("view code");o(U,A)},children:(U,A)=>{{let S=P(()=>`<${t(_)}>
	<Contextmenu>
		{#snippet entries()}
		...
		feedback. Use <!> only if you need
		iOS Safari support.</p> <h4>ContextmenuRoot</h4> <ul><li>standard, default implementation</li> <li>relies on the browser's <!></li> <li>much simpler, better performance with fewer and less intrusive event handlers, fewer edge
			cases that can go wrong</li> <li>does not work on iOS Safari until <a href="https://bugs.webkit.org/show_bug.cgi?id=213953">WebKit bug #213953</a> is fixed</li></ul> <h4>ContextmenuRootForSafariCompatibility</h4> <ul><li>opt-in hacky alternative when iOS support is needed</li> <li>implements custom longpress detection to work around iOS Safari's lacking <a href="https://bugs.webkit.org/show_bug.cgi?id=213953"><code>contextmenu</code> event support</a></li> <li>degraded experience because some browsers (including mobile Chrome) block <code>navigator.vibrate</code> haptic feedback due to the timeout-based gesture detection
			(because it's not a direct user action)</li> <li>works on all devices including iOS Safari</li> <li>more complex implementation with custom touch event handling and gesture detection, may cause
...
Try selecting text and then opening the contextmenu on it.`,f=P(()=>t(c)===h||t(c)===w||t(c)===m);var p=$t(),x=N(p);Ft(x,()=>t(C),(b,u)=>{u(b,{get contextmenu(){return _},scoped:!0,children:(g,R)=>{Pt(g,{children:(Z,H)=>{var X=mo(),B=N(X);let I;var E=s(B);It(E,{text:"Select text"}),a(B);var O=e(B,2);yt(O,{entries:D=>{nt(D,{run:()=>{F(r,!t(r))},children:(U,A)=>{k();var S=Y("Toggle something");o(U,S)},$$slots:{default:!0}})},children:(D,U)=>{var A=uo();let S;var z=s(A),W=e(s(z),2),K=e(s(W));let T;k(),a(W),a(z),oe(z,tt=>F(i,tt),()=>t(i));var V=e(z,2),Q=s(V);Rt(Q),a(V);var $=e(V,2);let L;var G=e($,2),J=s(G);Ie(J),a(G);var ot=e(G,2),dt=s(ot);Bt(dt,{path:"Web/HTML/Global_attributes/contenteditable"}),k(),a(ot);var q=e(ot,4),j=e(q,4);k(2),a(A),vt(()=>{S=it(A,1,"panel p_md",null,S,{color_g_5:t(f)}),T=it(K,1,"",null,T,{color_a:t(r)}),L=it($,1,"",null,L,{color_g_5:t(f)})}),ee("click",K,l),ue(Q,()=>t(c),tt=>F(c,tt)),ue(J,()=>t(c),tt=>F(c,tt)),ce("innerText",q,()=>t(c),tt=>F(c,tt)),ce("innerText",j,()=>t(c),tt=>F(c,tt)),o(D,A)},$$slots:{entries:!0,default:!0}}),vt(()=>I=it(B,1,"",null,I,{color_d_5:t(f)})),o(Z,X)},$$slots:{default:!0}})},$$slots:{default:!0}})}),o(v,p),ct()}te(["click"]);var _o=y('<div class="panel p_md mb_lg"><p>Try <button type="button">selecting some text</button> and opening the contextmenu in this panel.</p> <p>Try opening the contextmenu on <a>this link</a>.</p></div>'),po=y('<li>custom "some custom entry" entry</li>'),ho=y('<li>"copy text" entry when text is selected</li>'),fo=y("<li>link entry when clicking on a link</li>"),go=y("<p><strong>Expected:</strong> the Fuz contextmenu will open and show:</p> <ul><!> <!> <!></ul>",1),xo=y(`<p><strong>Expected:</strong> no behaviors defined. The system contextmenu will show, bypassing
			the Fuz contextmenu.</p>`),bo=y(`<!> <p>Check the boxes below to disable automatic <code>a</code> link detection and <code>copy text</code> detection, and see how the contextmenu behaves.</p> <!> <fieldset><label class="row"><input type="checkbox"/> <span>disable automatic link entries, <code></code></span></label> <label class="row"><input type="checkbox"/> <span>disable automatic copy text entries, <code></code></span></label></fieldset> <!> <p>When no behaviors are defined, the system contextmenu is shown instead.</p> <div class="mb_md"><label class="row"><input type="checkbox"/> include a custom entry, which
			ensures the Fuz contextmenu is used</label></div> <!>`,1);function yo(v,n){lt(n,!0);const d=p=>{var x=_o(),b=s(x),u=e(s(b));let g;k(),a(b),oe(b,H=>F(m,H),()=>t(m));var R=e(b,2),Z=e(s(R));k(),a(R),a(x),vt(H=>{g=it(u,1,"",null,g,{color_h:t(w)}),be(Z,"href",H)},[()=>vn("/")]),ee("click",u,f),o(p,x)},C=Et.get(),_=P(()=>C.component),r=P(()=>C.name),i=new jt;let l=et(!1),c=et(!1),h=et(!0),w=et(!1),m=et(void 0);const f=()=>{const p=window.getSelection();if(!p||!t(m))return;const x=document.createRange();x.selectNodeContents(t(m)),p.removeAllRanges(),p.addRange(x)};Pt(v,{children:(p,x)=>{var b=bo(),u=N(b);It(u,{text:"Disable default behaviors"});var g=e(u,4);{let T=P(()=>`<${t(r)}${t(l)?" link_entry={null}":""}${t(c)?" text_entry={null}":""}>`);Dt(g,{get content(){return t(T)}})}var R=e(g,2),Z=s(R),H=s(Z);Rt(H);var X=e(H,2),B=e(s(X));B.textContent="link_entry={null}",a(X),a(Z);var I=e(Z,2),E=s(I);Rt(E);var O=e(E,2),M=e(s(O));M.textContent="text_entry={null}",a(O),a(I),a(R);var D=e(R,2);{let T=P(()=>t(l)?null:void 0),V=P(()=>t(c)?null:void 0);Ft(D,()=>t(_),(Q,$)=>{$(Q,{get contextmenu(){return i},scoped:!0,get link_entry(){return t(T)},get text_entry(){return t(V)},children:(L,G)=>{var J=$t(),ot=N(J);{var dt=j=>{yt(j,{entries:_t=>{nt(_t,{icon:">",run:()=>{F(w,!t(w))},children:(Ot,Nt)=>{k();var gt=Y("some custom entry");o(Ot,gt)},$$slots:{default:!0}})},children:(_t,Ot)=>{d(_t)},$$slots:{entries:!0,default:!0}})},q=j=>{d(j)};at(ot,j=>{t(h)?j(dt):j(q,-1)})}o(L,J)},$$slots:{default:!0}})})}var U=e(D,4),A=s(U),S=s(A);Rt(S),k(),a(A),a(U);var z=e(U,2);{var W=T=>{var V=go(),Q=e(N(V),2),$=s(Q);{var L=q=>{var j=po();o(q,j)};at($,q=>{t(h)&&q(L)})}var G=e($,2);{var J=q=>{var j=ho();o(q,j)};at(G,q=>{t(c)||q(J)})}var ot=e(G,2);{var dt=q=>{var j=fo();o(q,j)};at(ot,q=>{t(l)||q(dt)})}a(Q),o(T,V)},K=T=>{var V=xo();o(T,V)};at(z,T=>{t(h)||!t(l)||!t(c)?T(W):T(K,-1)})}Kt(H,()=>t(l),T=>F(l,T)),Kt(E,()=>t(c),T=>F(c,T)),Kt(S,()=>t(h),T=>F(h,T)),o(p,b)},$$slots:{default:!0}}),ct()}te(["click"]);var $o=y(`<!> <div class="panel p_md"><!> <p>Opening the contextmenu on <a href="https://ui.fuz.dev/">a link like this one</a> has
				special behavior by default. To accesss your browser's normal contextmenu, open the
				contextmenu on the link inside the contextmenu itself or hold <code>Shift</code>.</p> <p>Although disruptive to default browser behavior, this allows links to have contextmenu
				behaviors, and it allows you to open the contextmenu anywhere to access all contextual
				behaviors.</p> <aside>Notice that opening the contextmenu on anything here except the link passes through to the
				browser's default contextmenu, because we didn't include any behaviors.</aside></div>`,1);function wo(v,n){lt(n,!0);const d=Et.get(),C=P(()=>d.component),_=P(()=>d.name);var r=$t(),i=N(r);Ft(i,()=>t(C),(l,c)=>{c(l,{scoped:!0,children:(h,w)=>{Pt(h,{children:(m,f)=>{var p=$o(),x=N(p);It(x,{text:"Default behaviors"});var b=e(x,2),u=s(b);{let g=P(()=>`<${t(_)} scoped>
  ...<a href="https://ui.fuz.dev/">
    a link like this one
  </a>...
</${t(_)}>`);Dt(u,{get content(){return t(g)}})}k(6),a(b),o(m,p)},$$slots:{default:!0}})},$$slots:{default:!0}})}),o(v,r),ct()}var Co=y("<!> <!> <!> <!> <!> <!> <!> <!> <section><aside><p>todo: demonstrate using <code>contextmenu_attachment</code> to avoid the wrapper element</p></aside> <aside><p>todo: for mobile, probably change to a drawer-from-bottom design</p></aside></section>",1);function ea(v,n){lt(n,!0);const C=Oe("Contextmenu");Et.set(),Ee(v,{get tome(){return C},children:(_,r)=>{var i=Co(),l=N(i);Cn(l,{});var c=e(l,2);Jn(c,{});var h=e(c,2);wo(h,{});var w=e(h,2);vo(w,{});var m=e(w,2);yo(m,{});var f=e(m,2);co(f,{});var p=e(f,2);Vn(p,{});var x=e(p,2);In(x),k(2),o(_,i)},$$slots:{default:!0}}),ct()}export{ea as component};

...
</${t(C)}>`);Lt(b,{get content(){return t(v)}})}y(6),r(x),o($,u)},$$slots:{default:!0}})},$$slots:{default:!0}})}),o(_,c),bt()}var yo=w("<!> <!> <!> <!> <!> <!> <!> <!> <section><aside><p>todo: demonstrate using <code>contextmenu_attachment</code> to avoid the wrapper element</p></aside> <aside><p>todo: for mobile, probably change to a drawer-from-bottom design</p></aside></section>",1);function Yo(_,n){gt(n,!0);const E=ze("Contextmenu");Nt.set(),Ae(_,{get tome(){return E},children:(C,c)=>{var a=yo(),s=I(a);gn(s,{});var l=e(s,2);Yn(l,{});var g=e(l,2);bo(g,{});var S=e(g,2);co(S,{});var $=e(S,2);xo($,{});var m=e($,2);ro(m,{});var u=e(m,2);Gn(u,{});var h=e(u,2);Cn(h),y(2),o(C,a)},$$slots:{default:!0}}),bt()}export{Yo as component};

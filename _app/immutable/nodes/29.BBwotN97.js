...
});`,lang:"ts"});var V=e(Q,4),_e=e(s(V));y(_e,{name:"CspTrustLevel"}),n(),t(V),n(2),t(R);var X=e(R,2);D(X,{children:(l,k)=>{var a=Oe(),d=v(a);O(d,{text:"Trust"});var i=e(d,2),p=e(s(i));y(p,{name:"CspTrustLevel"}),n(),t(i);var w=e(i,2);q(w,{content:`export const my_csp_trusted_sources: Array<CspSourceSpec> = [
...
];`});var _=e(w,2),x=s(_),m=s(x),h=e(s(m),2),b=e(s(h));y(b,{name:"required_trust_defaults_base"}),t(h),t(m),t(x);var S=e(x);ce(S,20,()=>E(pe),z=>z,(z,f)=>{var A=De(),$=s(A),G=s($);{let c=ie(()=>H(f));q(G,{get content(){return E(c)}})}t($);var I=e($);{var U=c=>{var C=je();r(c,C)},be=c=>{var C=Y(),ge=v(C);{var ke=P=>{var F=Me();r(P,F)},we=P=>{var F=Y(),xe=v(F);{var Se=T=>{var j=Le();r(T,j)},$e=T=>{var j=Y(),Ce=v(j);{var Pe=W=>{var Te=Ne();r(W,Te)};N(Ce,W=>{f==="high"&&W(Pe)},!0)}r(T,j)};N(xe,T=>{f==="medium"?T(Se):T($e,!1)},!0)}r(P,F)};N(ge,P=>{f==="low"?P(ke):P(we,!1)},!0)}r(c,C)};N(I,c=>{f===null?c(U):c(be,!1)})}var ae=e(I),oe=s(ae),ye=s(oe,!0);t(oe),t(ae),t(A),le(c=>L(ye,c),[()=>Object.entries(Fe).filter(([c,C])=>C===f).map(([c])=>H(c)).join(", ")]),r(z,A)}),t(S),t(_),n(2),r(l,a)},$$slots:{default:!0}});var Z=e(X,2);D(Z,{children:(l,k)=>{var a=Re(),d=v(a);O(d,{text:"Explicit directives"});var i=e(d,4);q(i,{content:`export const my_csp_trusted_sources: Array<CspSourceSpec> = [

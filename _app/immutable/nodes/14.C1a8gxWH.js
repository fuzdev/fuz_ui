import"../chunks/DsnmJJEf.js";import{p as gt,g as st,a as S,b as n,c as bt,h as wt,ah as Rt,f as b,am as kt,an as Vt,s as o,ai as ue,i as t,al as J,bo as Yt,ak as f,d as c,r as i,u as L,t as _t,ag as $,aa as O,e as $t,aj as Ne,bs as Re}from"../chunks/DuI-xSAA.js";import{T as Fe}from"../chunks/DdALwvgf.js";import{g as De}from"../chunks/CurcFKJC.js";import{c as Dt}from"../chunks/BNkRtQ8q.js";import{C as Ft}from"../chunks/Be4uwsUc.js";import{M as Xt}from"../chunks/DxSM8fMb.js";import{T as At,a as Ot}from"../chunks/CDpV4nCL.js";import{e as Le,t as jt,a as ve}from"../chunks/s1qKtV-X.js";import{g as ie,a as $e,f as le,r as Mt,d as ht,s as we,S as qe}from"../chunks/CQ48wsHn.js";import{p as lt,s as de,r as Me}from"../chunks/DGnOYeYA.js";import{c as He,C as Jt,a as Ce,b as ce,d as me}from"../chunks/lCbK41ZP.js";import{a as Ue,b as Be,c as We,d as je,e as Xe,f as Ge,g as Ve,h as ke,i as Te,j as Qt,k as Ye,l as pe,m as Kt,n as Ke,o as Ze,C as he,p as it}from"../chunks/B7xKzKa6.js";import{D as Se,b as fe}from"../chunks/oq4Ejtjz.js";import{a as xe,b as ge,c as se}from"../chunks/BQ5J6NaD.js";import{c as Je,r as Qe}from"../chunks/dSz7a-9Z.js";import{i as Q}from"../chunks/DIMZxS48.js";import{e as Gt}from"../chunks/D0KECqjk.js";import{b as te}from"../chunks/97aRKuuZ.js";import{s as Tt}from"../chunks/V2q5a4YM.js";import{c as tn,s as en}from"../chunks/DfIpPbHs.js";import{G as nn}from"../chunks/DPjeW6eT.js";import{S as on,g as an}from"../chunks/CY4tKIOB.js";import{C as rn,T as sn}from"../chunks/LGXHx4Pp.js";import{D as ln}from"../chunks/oMGbPhrv.js";function Ct(m,e){gt(e,!0);const u=lt(e,"tag",3,"span");var P=st(),w=S(P);Le(w,u,!1,(l,a)=>{ie(l,()=>He(e.entries)),$e(l,()=>({class:"display_contents",...e.attrs}));var r=st(),s=S(r);wt(s,()=>e.children),n(a,r)}),n(m,P),bt()}const cn=(m,e=Rt)=>{ke(m,de(e))},un=(m,e=Rt)=>{Te(m,de(e))},dn=(m,e=Rt)=>{Qt(m,de(e))};var _n=b('<div class="contextmenu_root svelte-1472w04" role="region"><!></div>'),vn=b('<div class="contextmenu_layout svelte-1472w04" aria-hidden="true"></div>'),mn=b('<ul class="contextmenu unstyled pane svelte-1472w04" role="menu" aria-label="context menu" tabindex="-1"></ul>'),pn=b("<!> <!> <!>",1);function hn(m,e){gt(e,!0);const u=lt(e,"contextmenu",19,()=>new Jt),P=lt(e,"longpress_move_tolerance",3,Ue),w=lt(e,"longpress_duration",3,Be),l=lt(e,"bypass_with_tap_then_longpress",3,!0),a=lt(e,"bypass_window",3,We),r=lt(e,"bypass_move_tolerance",3,je),s=lt(e,"open_offset_x",3,Xe),x=lt(e,"open_offset_y",3,Ge),F=lt(e,"scoped",3,!1),T=lt(e,"link_entry",3,cn),v=lt(e,"text_entry",3,un),_=lt(e,"separator_entry",3,dn);Ce.set(u());let p=J(void 0);const y=L(()=>u().layout),g=ce.set(),d=L(()=>Ke(u().x,g.width,t(y).width)),C=L(()=>Ze(u().y,g.height,t(y).height));let R=J(void 0),W=J(void 0),V=J(void 0),E=J(void 0),z=J(void 0),N=J(void 0),k=J(void 0),U=J(!1);const M=()=>{document.body.classList.add("contextmenu_pending")},j=()=>{document.body.classList.remove("contextmenu_pending")},I=()=>{f(z,!1),t(E)!=null&&(clearTimeout(t(E)),f(E,null)),j()},D=()=>{f(V,null),f(R,null),f(W,null),f(N,!1),t(k)!=null&&(clearTimeout(t(k)),f(k,null))},H=()=>{I(),D()},q=h=>{if(t(N)){D();return}const{target:A}=h;if(t(z)){if(t(p)?.contains(A))return;H(),Tt(h);return}pe(A,h.shiftKey)&&(t(p)?.contains(A)||me(A,h.clientX+s(),h.clientY+x(),u(),{link_enabled:T()!==null,text_enabled:v()!==null,separator_enabled:_()!==null})&&(Tt(h),H()))},Y=h=>{f(z,!1),f(U,!1);const{touches:A,target:G}=h;if(u().opened||A.length!==1||!pe(G,h.shiftKey)){H();return}const{clientX:tt,clientY:Z}=A[0];if(l()){if(t(V)!=null&&performance.now()-t(V)<a()&&Math.hypot(tt-t(R),Z-t(W))<r()){f(N,!0),f(V,null),f(R,null),f(W,null),t(k)!=null&&(clearTimeout(t(k)),f(k,null));return}f(V,performance.now(),!0),t(k)!=null&&clearTimeout(t(k)),f(k,setTimeout(()=>{D()},a()),!0)}f(R,tt,!0),f(W,Z,!0),M(),t(E)!=null&&I(),f(E,setTimeout(()=>{f(z,!0),j(),me(G,t(R)+s(),t(W)+x(),u(),{link_enabled:T()!==null,text_enabled:v()!==null,separator_enabled:_()!==null})},w()),!0)},B=h=>{if(t(E)==null||u().opened)return;const{touches:A}=h;if(A.length!==1)return;const{clientX:G,clientY:tt}=A[0];if(Math.hypot(G-t(R),tt-t(W))>P()){I();return}h.preventDefault()},et=h=>{t(E)!=null&&(t(z)&&(Tt(h),f(U,!0)),I()),t(N)&&D()},nt=()=>{H()},ut=h=>{t(p)&&!t(p).contains(h.target)&&u().close()},yt=Ve(u()),ft=Ye(yt),vt=h=>{const A={passive:!0,capture:!0},G={passive:!1,capture:!0},tt=Yt(h,"touchstart",Y,A),Z=Yt(h,"touchmove",B,G),pt=Yt(h,"touchend",et,G),at=Yt(h,"touchcancel",nt,A);return()=>{tt(),Z(),pt(),at()}};var ct=pn();kt("contextmenu",Vt,function(...h){(F()?void 0:q)?.apply(this,h)}),kt("mousedown",Vt,function(...h){(u().opened?ut:void 0)?.apply(this,h)}),kt("keydown",Vt,function(...h){(u().opened?ft:void 0)?.apply(this,h)}),ie(Vt,()=>F()?void 0:vt);var mt=S(ct);{var X=h=>{var A=_n();A.__contextmenu=q;var G=c(A);wt(G,()=>e.children),i(A),ie(A,()=>vt),n(h,A)},K=h=>{var A=st(),G=S(A);wt(G,()=>e.children),n(h,A)};Q(mt,h=>{F()?h(X):h(K,!1)})}var ot=o(mt,2);{var dt=h=>{var A=vn();Kt(A,"clientWidth",G=>t(y).width=G),Kt(A,"clientHeight",G=>t(y).height=G),n(h,A)};Q(ot,h=>{u().has_custom_layout||h(dt)})}var Nt=o(ot,2);{var St=h=>{var A=mn();let G;Gt(A,20,()=>u().params,tt=>tt,(tt,Z)=>{var pt=st(),at=S(pt);{var Pt=rt=>{var It=st(),Ht=S(It);wt(Ht,()=>Z),n(rt,It)},xt=rt=>{var It=st(),Ht=S(It);{var Et=Lt=>{var Ut=st(),oe=S(Ut);wt(oe,()=>T()??Rt,()=>Z.props),n(Lt,Ut)},ne=Lt=>{var Ut=st(),oe=S(Ut);{var Ee=qt=>{var Bt=st(),ae=S(Bt);wt(ae,()=>v()??Rt,()=>Z.props),n(qt,Bt)},Ae=qt=>{var Bt=st(),ae=S(Bt);{var Oe=re=>{var _e=st(),ze=S(_e);wt(ze,()=>_()??Rt,()=>Z.props),n(re,_e)};Q(ae,re=>{Z.snippet==="separator"&&re(Oe)},!0)}n(qt,Bt)};Q(oe,qt=>{Z.snippet==="text"?qt(Ee):qt(Ae,!1)},!0)}n(Lt,Ut)};Q(Ht,Lt=>{Z.snippet==="link"?Lt(Et):Lt(ne,!1)},!0)}n(rt,It)};Q(at,rt=>{typeof Z=="function"?rt(Pt):rt(xt,!1)})}n(tt,pt)}),i(A),te(A,tt=>f(p,tt),()=>t(p)),_t(()=>G=le(A,"",G,{transform:`translate3d(${t(d)??""}px, ${t(C)??""}px, 0)`})),kt("click",A,function(...tt){(t(U)?Z=>{f(U,!1),Tt(Z)}:void 0)?.apply(this,tt)},!0),Kt(A,"offsetWidth",tt=>g.width=tt),Kt(A,"offsetHeight",tt=>g.height=tt),n(h,A)};Q(Nt,h=>{u().opened&&h(St)})}n(m,ct),bt()}ue(["contextmenu"]);class fn{#t=J();get variant(){return t(this.#t)}set variant(e){f(this.#t,e,!0)}#e=L(()=>this.variant==="standard"?he:hn);get component(){return t(this.#e)}set component(e){f(this.#e,e)}#n=L(()=>this.component===he?"ContextmenuRoot":"ContextmenuRootForSafariCompatibility");get name(){return t(this.#n)}set name(e){f(this.#n,e)}constructor(e="standard"){this.variant=e}}const zt=Je(()=>new fn("standard"));var xn=b('<fieldset><legend><h4>Selected root component:</h4></legend> <label class="row"><input type="radio"/> <div>standard <code>ContextmenuRoot</code></div></label> <label class="row"><input type="radio"/> <div>iOS compat <code>ContextmenuRootForSafariCompatibility</code></div></label></fieldset>');function Pe(m,e){gt(e,!0);const u=[],P=zt.get();var w=xn(),l=o(c(w),2),a=c(l);Mt(a),a.value=a.__value="standard",$(2),i(l);var r=o(l,2),s=c(r);Mt(s),s.value=s.__value="compat",$(2),i(r),i(w),xe(u,[],a,()=>P.variant,x=>P.variant=x),xe(u,[],s,()=>P.variant,x=>P.variant=x),n(m,w),bt()}var gn=b('<p class="panel p_md">alert B -- also inherits A</p>'),bn=b('<div class="panel p_md mb_lg"><p>alert A -- rightclick or longpress here to open the contextmenu</p> <!></div>'),yn=b("<code>navigator.vibrate</code>"),$n=b(`<!> <p>Fuz provides a customizable contextmenu that overrides the system contextmenu to provide helpful
...
</${t(w)}>`);Ft(g,{get content(){return t(d)}})}$(6),i(y),n(T,_)},$$slots:{default:!0}})},$$slots:{default:!0}})}),n(m,l),bt()}var zo=b("<!> <!> <!> <!> <!> <!> <!> <!> <section><aside><p>todo: demonstrate using <code>contextmenu_attachment</code> to avoid the wrapper element</p></aside> <aside><p>todo: for mobile, probably change to a drawer-from-bottom design</p></aside></section>",1);function ra(m,e){gt(e,!0);const P=De("Contextmenu");zt.set(),Fe(m,{get tome(){return P},children:(w,l)=>{var a=zo(),r=S(a);wn(r,{});var s=o(r,2);lo(s,{});var x=o(s,2);Oo(x,{});var F=o(x,2);$o(F,{});var T=o(F,2);Eo(T,{});var v=o(T,2);go(v,{});var _=o(v,2);ao(_,{});var p=o(_,2);Pn(p),$(2),n(w,a)},$$slots:{default:!0}}),bt()}export{ra as component};

import"../chunks/DsnmJJEf.js";import{p as ft,g as dt,a as E,b as n,c as xt,h as kt,ap as Ft,f as b,au as St,av as jt,s as o,j as t,u as I,aq as oe,at as J,bw as Xt,as as h,d as c,r as i,aw as ae,t as _t,n as $,i as N,e as Ct,ar as ke,bA as Te}from"../chunks/Q8-Pn4tq.js";import{T as Se}from"../chunks/BLoo-CnR.js";import{g as Pe}from"../chunks/Dboec56i.js";import{c as Lt}from"../chunks/JVe3DFko.js";import{C as Dt}from"../chunks/DKEESepN.js";import{M as Bt}from"../chunks/DdJSgFyx.js";import{T as Ot,a as zt}from"../chunks/BYbeNjkV.js";import{e as Ie,t as Ut,a as re}from"../chunks/CxCTED--.js";import{g as te,b as pe,S as he,a as ee,r as qt,f as ht,s as fe}from"../chunks/CwAqK9-j.js";import{p as it,r as xe,i as tt,s as se}from"../chunks/DX1PSTnx.js";import{c as Ee,C as Yt,a as ge,b as ne,d as ie}from"../chunks/Bqr1-IIn.js";import{a as Ae,b as Oe,c as ze,d as Ne,e as Re,f as Fe,g as be,h as ye,i as Kt,j as le,k as De,l as Le,m as Gt,n as qe,o as Me,C as ce,p as st}from"../chunks/xvS7UeUT.js";import{D as $e,b as ue}from"../chunks/ClVr4KK9.js";import{a as de,b as _e,c as Qt}from"../chunks/lBfoBFAp.js";import{c as He,r as Ue}from"../chunks/BB74VeYj.js";import{e as Wt}from"../chunks/C4R20_0N.js";import{b as Zt}from"../chunks/56dGVK6m.js";import{s as Pt}from"../chunks/V2q5a4YM.js";import{c as Be,s as We}from"../chunks/DfIpPbHs.js";import{G as je}from"../chunks/CTRcmLen.js";import{S as Xe,b as Ge}from"../chunks/DVj5vPpM.js";import{C as Ve,T as Ye}from"../chunks/BGCSwWuz.js";import{D as Ke}from"../chunks/BsQhz82O.js";function Tt(m,e){ft(e,!0);const u=it(e,"tag",3,"span"),P=xe(e,["$$slots","$$events","$$legacy","tag","entries","children"]);var w=dt(),l=E(w);Ie(l,u,!1,(a,s)=>{te(a,()=>Ee(e.entries)),pe(a,()=>({...P,[he]:{display:"contents"}}));var r=dt(),x=E(r);kt(x,()=>e.children),n(s,r)}),n(m,w),xt()}const Ze=(m,e=Ft)=>{be(m,se(e))},Je=(m,e=Ft)=>{ye(m,se(e))},Qe=(m,e=Ft)=>{Kt(m,se(e))};var tn=b('<div class="contextmenu_root svelte-1472w04" role="region"><!></div>'),en=b('<div class="contextmenu_layout svelte-1472w04" aria-hidden="true"></div>'),nn=b('<ul class="contextmenu unstyled pane svelte-1472w04" role="menu" aria-label="context menu" tabindex="-1"></ul>'),on=b("<!> <!> <!>",1);function an(m,e){ft(e,!0);const u=it(e,"contextmenu",19,()=>new Yt),P=it(e,"longpress_move_tolerance",3,Ae),w=it(e,"longpress_duration",3,Oe),l=it(e,"bypass_with_tap_then_longpress",3,!0),a=it(e,"bypass_window",3,ze),s=it(e,"bypass_move_tolerance",3,Ne),r=it(e,"open_offset_x",3,Re),x=it(e,"open_offset_y",3,Fe),A=it(e,"scoped",3,!1),T=it(e,"link_entry",3,Ze),v=it(e,"text_entry",3,Je),d=it(e,"separator_entry",3,Qe);ge.set(()=>u());let f=J(void 0);const y=I(()=>u().layout),g=ne.set(),_=I(()=>qe(u().x,g.width,t(y).width)),C=I(()=>Me(u().y,g.height,t(y).height));let F=J(void 0),B=J(void 0),G=J(void 0),O=J(void 0),W=J(void 0),R=J(void 0),k=J(void 0),q=J(!1);const H=()=>{document.body.classList.add("contextmenu_pending")},K=()=>{document.body.classList.remove("contextmenu_pending")},S=()=>{h(W,!1),t(O)!=null&&(clearTimeout(t(O)),h(O,null)),K()},D=()=>{h(G,null),h(F,null),h(B,null),h(R,!1),t(k)!=null&&(clearTimeout(t(k)),h(k,null))},M=()=>{S(),D()},U=p=>{if(t(R)){D();return}const{target:z}=p;if(t(W)){if(t(f)?.contains(z))return;M(),Pt(p);return}le(z,p.shiftKey)&&(t(f)?.contains(z)||ie(z,p.clientX+r(),p.clientY+x(),u(),{link_enabled:T()!==null,text_enabled:v()!==null,separator_enabled:d()!==null})&&(Pt(p),M()))},V=p=>{h(W,!1),h(q,!1);const{touches:z,target:X}=p;if(u().opened||z.length!==1||!le(X,p.shiftKey)){M();return}const{clientX:Q,clientY:Z}=z[0];if(l()){if(t(G)!=null&&performance.now()-t(G)<a()&&Math.hypot(Q-t(F),Z-t(B))<s()){h(R,!0),h(G,null),h(F,null),h(B,null),t(k)!=null&&(clearTimeout(t(k)),h(k,null));return}h(G,performance.now(),!0),t(k)!=null&&clearTimeout(t(k)),h(k,setTimeout(()=>{D()},a()),!0)}h(F,Q,!0),h(B,Z,!0),H(),t(O)!=null&&S(),h(O,setTimeout(()=>{h(W,!0),K(),ie(X,t(F)+r(),t(B)+x(),u(),{link_enabled:T()!==null,text_enabled:v()!==null,separator_enabled:d()!==null})},w()),!0)},L=p=>{if(t(O)==null||u().opened)return;const{touches:z}=p;if(z.length!==1)return;const{clientX:X,clientY:Q}=z[0];if(Math.hypot(X-t(F),Q-t(B))>P()){S();return}p.preventDefault()},et=p=>{t(O)!=null&&(t(W)&&(Pt(p),h(q,!0)),S()),t(R)&&D()},nt=()=>{M()},ct=p=>{t(f)&&!t(f).contains(p.target)&&u().close()},wt=I(()=>Le(u())),gt=I(()=>De(t(wt))),vt=p=>{const z={passive:!0,capture:!0},X={passive:!1,capture:!0},Q=Xt(p,"touchstart",V,z),Z=Xt(p,"touchmove",L,X),pt=Xt(p,"touchend",et,X),at=Xt(p,"touchcancel",nt,z);return()=>{Q(),Z(),pt(),at()}};var lt=on();St("contextmenu",jt,function(...p){(A()?void 0:U)?.apply(this,p)}),St("mousedown",jt,function(...p){(u().opened?ct:void 0)?.apply(this,p)}),St("keydown",jt,function(...p){(u().opened?t(gt):void 0)?.apply(this,p)}),te(jt,()=>A()?void 0:vt);var mt=E(lt);{var j=p=>{var z=tn(),X=c(z);kt(X,()=>e.children),i(z),te(z,()=>vt),ae("contextmenu",z,U),n(p,z)},Y=p=>{var z=dt(),X=E(z);kt(X,()=>e.children),n(p,z)};tt(mt,p=>{A()?p(j):p(Y,-1)})}var ot=o(mt,2);{var ut=p=>{var z=en();Gt(z,"clientWidth",X=>t(y).width=X),Gt(z,"clientHeight",X=>t(y).height=X),n(p,z)};tt(ot,p=>{u().has_custom_layout||p(ut)})}var Rt=o(ot,2);{var It=p=>{var z=nn();let X;Wt(z,20,()=>u().params,Q=>Q,(Q,Z)=>{var pt=dt(),at=E(pt);{var Et=$t=>{var rt=dt(),At=E(rt);kt(At,()=>Z),n($t,rt)},bt=$t=>{var rt=dt(),At=E(rt);kt(At,()=>T()??Ft,()=>Z.props),n($t,rt)},yt=$t=>{var rt=dt(),At=E(rt);kt(At,()=>v()??Ft,()=>Z.props),n($t,rt)},Mt=$t=>{var rt=dt(),At=E(rt);kt(At,()=>d()??Ft,()=>Z.props),n($t,rt)};tt(at,$t=>{typeof Z=="function"?$t(Et):Z.snippet==="link"?$t(bt,1):Z.snippet==="text"?$t(yt,2):Z.snippet==="separator"&&$t(Mt,3)})}n(Q,pt)}),i(z),Zt(z,Q=>h(f,Q),()=>t(f)),_t(()=>X=ee(z,"",X,{transform:`translate3d(${t(_)??""}px, ${t(C)??""}px, 0)`})),St("click",z,function(...Q){(t(q)?Z=>{h(q,!1),Pt(Z)}:void 0)?.apply(this,Q)},!0),Gt(z,"offsetWidth",Q=>g.width=Q),Gt(z,"offsetHeight",Q=>g.height=Q),n(p,z)};tt(Rt,p=>{u().opened&&p(It)})}n(m,lt),xt()}oe(["contextmenu"]);class sn{#t=J();get variant(){return t(this.#t)}set variant(e){h(this.#t,e,!0)}#e=I(()=>this.variant==="standard"?ce:an);get component(){return t(this.#e)}set component(e){h(this.#e,e)}#n=I(()=>this.component===ce?"ContextmenuRoot":"ContextmenuRootForSafariCompatibility");get name(){return t(this.#n)}set name(e){h(this.#n,e)}constructor(e="standard"){this.variant=e}}const Nt=He(()=>new sn("standard"));var rn=b('<fieldset><legend><h4>Selected root component:</h4></legend> <label class="row"><input type="radio"/> <div>standard <code>ContextmenuRoot</code></div></label> <label class="row"><input type="radio"/> <div>iOS compat <code>ContextmenuRootForSafariCompatibility</code></div></label></fieldset>');function we(m,e){ft(e,!0);const u=[],P=Nt.get();var w=rn(),l=o(c(w),2),a=c(l);qt(a),a.value=a.__value="standard",$(2),i(l);var s=o(l,2),r=c(s);qt(r),r.value=r.__value="compat",$(2),i(s),i(w),de(u,[],a,()=>P.variant,x=>P.variant=x),de(u,[],r,()=>P.variant,x=>P.variant=x),n(m,w),xt()}var ln=b('<p class="panel p_md">alert B -- also inherits A</p>'),cn=b('<div class="panel p_md mb_lg"><p>alert A -- rightclick or longpress here to open the contextmenu</p> <!></div>'),un=b("<code>navigator.vibrate</code>"),dn=b(`<!> <p>Fuz provides a customizable contextmenu that overrides the system contextmenu to provide helpful
	...
	<Contextmenu>
...
</${t(w)}>`);Dt(G,{get content(){return t(W)}})}},$$slots:{summary:!0,default:!0}});var g=o(y,14),_=o(c(g),2),C=o(c(_));Bt(C,{path:"Web/API/Navigator/vibrate",children:(B,G)=>{var O=un();n(B,O)},$$slots:{default:!0}}),i(_),i(g);var F=o(g,2);we(F,{}),_t(()=>Ct(d,t(w))),n(l,s)},$$slots:{default:!0}}),xt()}var vn=b('<span class="font_family_mono">contextmenu</span> event',1),mn=b(`<!> <p>Fuz provides two versions of the contextmenu root component with different tradeoffs due to iOS
		...
		behavior by replacing the system contextmenu.</p> <p>To mitigate the downsides:</p> <ul><li>The Fuz contextmenu only replaces the system contextmenu when the DOM tree has defined
			...
			configurable.</li> <li>To bypass on devices with a keyboard, hold Shift while rightclicking.</li> <li>To bypass on touch devices (e.g. to select text), use tap-then-longpress instead of longpress.</li> <li>Triggering the contextmenu inside the Fuz contextmenu shows the system contextmenu.</li></ul> <p>See also the <!> docs and the <a href="https://www.w3.org/TR/uievents/#event-type-contextmenu">w3 spec</a>.</p>`,1),hn=b("<!> <!>",1);function fn(m){var e=hn(),u=E(e);Ot(u,{children:(w,l)=>{var a=mn(),s=E(a);zt(s,{text:"iOS compatibility"});var r=o(s,8),x=o(c(r),2),A=o(c(x));Bt(A,{path:"Web/API/Element/contextmenu_event",children:(v,d)=>{var f=vn();$(),n(v,f)},$$slots:{default:!0}}),i(x),$(4),i(r);var T=o(r,6);we(T,{}),n(w,a)},$$slots:{default:!0}});var P=o(u,2);Ot(P,{children:(w,l)=>{var a=pn(),s=E(a);zt(s,{text:"Caveats"});var r=o(s,8),x=o(c(r));Bt(x,{path:"Web/API/Element/contextmenu_event"}),$(3),i(r),n(w,a)},$$slots:{default:!0}}),n(m,e)}function xn(m){const e=m-1;return e*e*e+1}function gn(m){return--m*m*m*m*m+1}function ve(m,{from:e,to:u},P={}){var{delay:w=0,duration:l=O=>Math.sqrt(O)*120,easing:a=xn}=P,s=getComputedStyle(m),r=s.transform==="none"?"":s.transform,[x,A]=s.transformOrigin.split(" ").map(parseFloat);x/=m.clientWidth,A/=m.clientHeight;var T=bn(m),v=m.clientWidth/u.width/T,d=m.clientHeight/u.height/T,f=e.left+e.width*x,y=e.top+e.height*A,g=u.left+u.width*x,_=u.top+u.height*A,C=(f-g)*v,F=(y-_)*d,B=e.width/u.width,G=e.height/u.height;return{delay:w,duration:typeof l=="function"?l(Math.sqrt(C*C+F*F)):l,easing:a,css:(O,W)=>{var R=W*C,k=W*F,q=O+W*B,H=O+W*G;return`transform: ${r} translate(${R}px, ${k}px) scale(${q}, ${H});`}}}function bn(m){if("currentCSSZoom"in m)return m.currentCSSZoom;for(var e=m,u=1;e!==null;)u*=+getComputedStyle(e).zoom,e=e.parentElement;return u}var yn=b('<menu class="pane unstyled svelte-6kuqba"><!></menu>'),$n=b('<li role="none" class="svelte-6kuqba"><div role="menuitem" aria-label="contextmenu submenmu" aria-haspopup="menu" tabindex="-1"><div class="content"><div class="icon"><!></div> <div class="title"><!></div></div> <div class="chevron svelte-6kuqba" aria-hidden="true"></div></div> <!></li>');function Jt(m,e){ft(e,!0);const u=ge.get(),P=I(u),w=u().add_submenu(),l=I(()=>t(P).layout),a=I(()=>w.selected);let s=J(void 0);const r=ne.get(),x=ne.set();let A=J(0),T=J(0);ke(()=>{t(s)&&v(t(s),t(l),r)});const v=(R,k,q)=>{const{x:H,y:K,width:S,height:D}=R.getBoundingClientRect();x.width=S,x.height=D;const M=H-t(A),U=K-t(T),V=M+S+q.width-k.width;if(V<=0)h(A,q.width,!0);else{const L=S-M;L<=0?h(A,-S):L>V?h(A,q.width-V):h(A,L-S)}h(T,Math.min(0,k.height-(U+D)),!0)};var d=$n();let f;var y=c(d);let g;var _=c(y),C=c(_),F=c(C);kt(F,()=>e.icon??Ft),i(C);var B=o(C,2),G=c(B);kt(G,()=>e.children),i(B),i(_),$(2),i(y);var O=o(y,2);{var W=R=>{var k=yn();let q;var H=c(k);kt(H,()=>e.menu),i(k),Zt(k,K=>h(s,K),()=>t(s)),_t(()=>q=ee(k,"",q,{transform:`translate3d(${t(A)??""}px, ${t(T)??""}px, 0)`,"max-height":`${t(l).height??""}px`})),n(R,k)};tt(O,R=>{t(a)&&R(W)})}i(d),_t(()=>{f=ee(d,"",f,{"--contextmenu_depth":w.depth}),g=ht(y,1,"menu_item plain selectable svelte-6kuqba",null,g,{selected:t(a)}),fe(y,"aria-expanded",t(a))}),St("mouseenter",y,R=>{Pt(R),setTimeout(()=>t(P).select(w))}),n(m,d),xt()}var wn=b("<!> <!>",1);function Vt(m,e){ft(e,!0);const u=it(e,"name",3,"Cat"),P=it(e,"icon",3,"😺");Jt(m,{icon:a=>{$();var s=N();_t(()=>Ct(s,P())),n(a,s)},menu:a=>{var s=wn(),r=E(s);st(r,{run:()=>e.act({type:e.position==="adventure"?"cat_go_home":"cat_go_adventure",name:u()}),icon:T=>{var v=dt(),d=E(v);{var f=g=>{var _=N("🏠");n(g,_)},y=g=>{var _=N("🌄");n(g,_)};tt(d,g=>{e.position==="adventure"?g(f):g(y,-1)})}n(T,v)},children:(T,v)=>{var d=dt(),f=E(d);{var y=_=>{var C=N("go home");n(_,C)},g=_=>{var C=N("go adventure");n(_,C)};tt(f,_=>{e.position==="adventure"?_(y):_(g,-1)})}n(T,d)},$$slots:{icon:!0,default:!0}});var x=o(r,2);st(x,{run:()=>e.act({type:"cat_be_or_do",name:u(),position:e.position}),icon:T=>{var v=dt(),d=E(v);{var f=g=>{var _=N("🌄");n(g,_)},y=g=>{var _=N("🏠");n(g,_)};tt(d,g=>{e.position==="adventure"?g(f):g(y,-1)})}n(T,v)},children:(T,v)=>{var d=dt(),f=E(d);{var y=_=>{var C=N("do adventure");n(_,C)},g=_=>{var C=N("be home");n(_,C)};tt(f,_=>{e.position==="adventure"?_(y):_(g,-1)})}n(T,d)},$$slots:{icon:!0,default:!0}}),n(a,s)},children:(a,s)=>{$();var r=N();_t(()=>Ct(r,u())),n(a,r)},$$slots:{icon:!0,menu:!0,default:!0}}),xt()}var Cn=b("<!> <!> <!>",1);function kn(m,e){var u=Cn(),P=E(u);be(P,{href:"https://github.com/fuzdev/fuz_ui",icon:s=>{Xe(s,{get data(){return Ge},size:"var(--icon_size_xs)"})},children:(s,r)=>{$();var x=N("Source code");n(s,x)},$$slots:{icon:!0,default:!0}});var w=o(P,2);Kt(w,{});var l=o(w,2);st(l,{get run(){return e.toggle_about_dialog},icon:s=>{$();var r=N("?");n(s,r)},children:(s,r)=>{$();var x=N("About");n(s,x)},$$slots:{icon:!0,default:!0}}),n(m,u)}const Ce=m=>{const e=m.length;if(e===2)return"cats";if(e===0)return null;const u=m[0];return u.icon+u.name};var Tn=b("<!> <!>",1),Sn=b("<!> <!>",1),Pn=b("<!> <!> <!>",1);function In(m,e){ft(e,!0);const u=I(()=>Ce(e.adventure_cats));Jt(m,{icon:l=>{$();var a=N("🏠");n(l,a)},menu:l=>{var a=Pn(),s=E(a);{var r=v=>{var d=Tn(),f=E(d);st(f,{run:()=>e.act({type:"call_cats_home"}),icon:_=>{$();var C=N("🐈‍⬛");n(_,C)},children:(_,C)=>{$();var F=N("call");n(_,F)},$$slots:{icon:!0,default:!0}});var y=o(f,2);Kt(y,{}),n(v,d)};tt(s,v=>{t(u)&&v(r)})}var x=o(s,2);Wt(x,17,()=>e.home_cats,v=>v.name,(v,d)=>{Vt(v,{get name(){return t(d).name},get icon(){return t(d).icon},get position(){return t(d).position},get act(){return e.act}})});var A=o(x,2);{var T=v=>{var d=Sn(),f=E(d);st(f,{run:()=>e.act({type:"cat_be_or_do",name:null,position:"home"}),icon:_=>{$();var C=N("🏠");n(_,C)},children:(_,C)=>{$();var F=N("be");n(_,F)},$$slots:{icon:!0,default:!0}});var y=o(f,2);st(y,{run:()=>e.act({type:"call_cats_adventure"}),icon:_=>{$();var C=N("🦋");n(_,C)},children:(_,C)=>{$();var F=N("leave");n(_,F)},$$slots:{icon:!0,default:!0}}),n(v,d)};tt(A,v=>{t(u)||v(T)})}n(l,a)},children:(l,a)=>{$();var s=N("home");n(l,s)},$$slots:{icon:!0,menu:!0,default:!0}}),xt()}var En=b("<!> <!>",1),An=b("<!> <!>",1),On=b("<!> <!> <!>",1);function zn(m,e){ft(e,!0);const u=I(()=>Ce(e.home_cats));Jt(m,{icon:l=>{$();var a=N("🌄");n(l,a)},menu:l=>{var a=On(),s=E(a);{var r=v=>{var d=En(),f=E(d);st(f,{run:()=>e.act({type:"call_cats_adventure"}),icon:_=>{$();var C=N("🦋");n(_,C)},children:(_,C)=>{$();var F=N("call");n(_,F)},$$slots:{icon:!0,default:!0}});var y=o(f,2);Kt(y,{}),n(v,d)};tt(s,v=>{t(u)&&v(r)})}var x=o(s,2);Wt(x,17,()=>e.adventure_cats,v=>v.name,(v,d)=>{Vt(v,{get name(){return t(d).name},get icon(){return t(d).icon},get position(){return t(d).position},get act(){return e.act}})});var A=o(x,2);{var T=v=>{var d=An(),f=E(d);st(f,{run:()=>e.act({type:"cat_be_or_do",name:null,position:"adventure"}),icon:_=>{$();var C=N("🌄");n(_,C)},children:(_,C)=>{$();var F=N("do");n(_,F)},$$slots:{icon:!0,default:!0}});var y=o(f,2);st(y,{run:()=>e.act({type:"call_cats_home"}),icon:_=>{$();var C=N("🐈‍⬛");n(_,C)},children:(_,C)=>{$();var F=N("leave");n(_,F)},$$slots:{icon:!0,default:!0}}),n(v,d)};tt(A,v=>{t(u)||v(T)})}n(l,a)},children:(l,a)=>{$();var s=N("adventure");n(l,s)},$$slots:{icon:!0,menu:!0,default:!0}}),xt()}var Nn=b('<span class="icon svelte-1py4cgo"> </span>'),Rn=b('<span class="name svelte-1py4cgo"><!> </span>'),Fn=b("<span><!><!></span>");function me(m,e){const u=it(e,"name",3,"Cat"),P=it(e,"icon",3,"😺"),w=it(e,"show_name",3,!0),l=it(e,"show_icon",3,!0);var a=Fn();let s;var r=c(a);{var x=v=>{var d=Nn(),f=c(d,!0);i(d),_t(()=>Ct(f,P())),n(v,d)};tt(r,v=>{l()&&v(x)})}var A=o(r);{var T=v=>{var d=Rn(),f=c(d);kt(f,()=>e.children??Ft);var y=o(f,1,!0);i(d),_t(()=>Ct(y,u())),n(v,d)};tt(A,v=>{w()&&v(T)})}i(a),_t(()=>s=ht(a,1,"cat svelte-1py4cgo",null,s,{"has-icon":l()})),n(m,a)}const Dn=`<script lang="ts">
...
Try selecting text and then opening the contextmenu on it.`,v=I(()=>t(r)===x||t(r)===A||t(r)===T);var d=dt(),f=E(d);Lt(f,()=>t(P),(y,g)=>{g(y,{get contextmenu(){return w},scoped:!0,children:(_,C)=>{Ot(_,{children:(F,B)=>{var G=co(),O=E(G);let W;var R=c(O);zt(R,{text:"Select text"}),i(O);var k=o(O,2);Tt(k,{entries:H=>{st(H,{run:()=>{h(l,!t(l))},children:(K,S)=>{$();var D=N("Toggle something");n(K,D)},$$slots:{default:!0}})},children:(H,K)=>{var S=lo();let D;var M=c(S),U=o(c(M),2),V=o(c(U));let L;$(),i(U),i(M),Zt(M,ot=>h(a,ot),()=>t(a));var et=o(M,2),nt=c(et);qt(nt),i(et);var ct=o(et,2);let wt;var gt=o(ct,2),vt=c(gt);Te(vt),i(gt);var lt=o(gt,2),mt=c(lt);Bt(mt,{path:"Web/HTML/Global_attributes/contenteditable"}),$(),i(lt);var j=o(lt,4),Y=o(j,4);$(2),i(S),_t(()=>{D=ht(S,1,"panel p_md",null,D,{color_g_5:t(v)}),L=ht(V,1,"",null,L,{color_a:t(l)}),wt=ht(ct,1,"",null,wt,{color_g_5:t(v)})}),ae("click",V,s),_e(nt,()=>t(r),ot=>h(r,ot)),_e(vt,()=>t(r),ot=>h(r,ot)),ue("innerText",j,()=>t(r),ot=>h(r,ot)),ue("innerText",Y,()=>t(r),ot=>h(r,ot)),n(H,S)},$$slots:{entries:!0,default:!0}}),_t(()=>W=ht(O,1,"",null,W,{color_d_5:t(v)})),n(F,G)},$$slots:{default:!0}})},$$slots:{default:!0}})}),n(m,d),xt()}oe(["click"]);var _o=b('<div class="panel p_md mb_lg"><p>Try <button type="button">selecting some text</button> and opening the contextmenu in this panel.</p> <p>Try opening the contextmenu on <a>this link</a>.</p></div>'),vo=b('<li>custom "some custom entry" entry</li>'),mo=b('<li>"copy text" entry when text is selected</li>'),po=b("<li>link entry when clicking on a link</li>"),ho=b("<p><strong>Expected:</strong> the Fuz contextmenu will open and show:</p> <ul><!> <!> <!></ul>",1),fo=b(`<p><strong>Expected:</strong> no behaviors defined. The system contextmenu will show, bypassing the
			Fuz contextmenu.</p>`),xo=b('<!> <p>Check the boxes below to disable automatic <code>a</code> link detection and <code>copy text</code> detection, and see how the contextmenu behaves.</p> <!> <fieldset><label class="row"><input type="checkbox"/> <span>disable automatic link entries, <code></code></span></label> <label class="row"><input type="checkbox"/> <span>disable automatic copy text entries, <code></code></span></label></fieldset> <!> <p>When no behaviors are defined, the system contextmenu is shown instead.</p> <div class="mb_md"><label class="row"><input type="checkbox"/> include a custom entry, which ensures the Fuz contextmenu is used</label></div> <!>',1);function go(m,e){ft(e,!0);const u=d=>{var f=_o(),y=c(f),g=o(c(y));let _;$(),i(y),Zt(y,B=>h(T,B),()=>t(T));var C=o(y,2),F=o(c(C));$(),i(C),i(f),_t(B=>{_=ht(g,1,"",null,_,{color_h:t(A)}),fe(F,"href",B)},[()=>Ue("/")]),ae("click",g,v),n(d,f)},P=Nt.get(),w=I(()=>P.component),l=I(()=>P.name),a=new Yt;let s=J(!1),r=J(!1),x=J(!0),A=J(!1),T=J(void 0);const v=()=>{const d=window.getSelection();if(!d||!t(T))return;const f=document.createRange();f.selectNodeContents(t(T)),d.removeAllRanges(),d.addRange(f)};Ot(m,{children:(d,f)=>{var y=xo(),g=E(y);zt(g,{text:"Disable default behaviors"});var _=o(g,4);{let L=I(()=>`<${t(l)}${t(s)?" link_entry={null}":""}${t(r)?" text_entry={null}":""}>`);Dt(_,{get content(){return t(L)}})}var C=o(_,2),F=c(C),B=c(F);qt(B);var G=o(B,2),O=o(c(G));O.textContent="link_entry={null}",i(G),i(F);var W=o(F,2),R=c(W);qt(R);var k=o(R,2),q=o(c(k));q.textContent="text_entry={null}",i(k),i(W),i(C);var H=o(C,2);{let L=I(()=>t(s)?null:void 0),et=I(()=>t(r)?null:void 0);Lt(H,()=>t(w),(nt,ct)=>{ct(nt,{get contextmenu(){return a},scoped:!0,get link_entry(){return t(L)},get text_entry(){return t(et)},children:(wt,gt)=>{var vt=dt(),lt=E(vt);{var mt=Y=>{Tt(Y,{entries:ut=>{st(ut,{icon:">",run:()=>{h(A,!t(A))},children:(Rt,It)=>{$();var p=N("some custom entry");n(Rt,p)},$$slots:{default:!0}})},children:(ut,Rt)=>{u(ut)},$$slots:{entries:!0,default:!0}})},j=Y=>{u(Y)};tt(lt,Y=>{t(x)?Y(mt):Y(j,-1)})}n(wt,vt)},$$slots:{default:!0}})})}var K=o(H,4),S=c(K),D=c(S);qt(D),$(),i(S),i(K);var M=o(K,2);{var U=L=>{var et=ho(),nt=o(E(et),2),ct=c(nt);{var wt=j=>{var Y=vo();n(j,Y)};tt(ct,j=>{t(x)&&j(wt)})}var gt=o(ct,2);{var vt=j=>{var Y=mo();n(j,Y)};tt(gt,j=>{t(r)||j(vt)})}var lt=o(gt,2);{var mt=j=>{var Y=po();n(j,Y)};tt(lt,j=>{t(s)||j(mt)})}i(nt),n(L,et)},V=L=>{var et=fo();n(L,et)};tt(M,L=>{t(x)||!t(s)||!t(r)?L(U):L(V,-1)})}Qt(B,()=>t(s),L=>h(s,L)),Qt(R,()=>t(r),L=>h(r,L)),Qt(D,()=>t(x),L=>h(x,L)),n(d,y)},$$slots:{default:!0}}),xt()}oe(["click"]);var bo=b(`<!> <div class="panel p_md"><!> <p>Opening the contextmenu on <a href="https://ui.fuz.dev/">a link like this one</a> has
				special behavior by default. To accesss your browser's normal contextmenu, open the
				contextmenu on the link inside the contextmenu itself or hold <code>Shift</code>.</p> <p>Although disruptive to default browser behavior, this allows links to have contextmenu
				behaviors, and it allows you to open the contextmenu anywhere to access all contextual
				behaviors.</p> <aside>Notice that opening the contextmenu on anything here except the link passes through to the
				browser's default contextmenu, because we didn't include any behaviors.</aside></div>`,1);function yo(m,e){ft(e,!0);const u=Nt.get(),P=I(()=>u.component),w=I(()=>u.name);var l=dt(),a=E(l);Lt(a,()=>t(P),(s,r)=>{r(s,{scoped:!0,children:(x,A)=>{Ot(x,{children:(T,v)=>{var d=bo(),f=E(d);zt(f,{text:"Default behaviors"});var y=o(f,2),g=c(y);{let _=I(()=>`<${t(w)} scoped>
  ...<a href="https://ui.fuz.dev/">
    a link like this one
  </a>...
</${t(w)}>`);Dt(g,{get content(){return t(_)}})}$(6),i(y),n(T,d)},$$slots:{default:!0}})},$$slots:{default:!0}})}),n(m,l),xt()}var $o=b("<!> <!> <!> <!> <!> <!> <!> <!> <section><aside><p>todo: demonstrate using <code>contextmenu_attachment</code> to avoid the wrapper element</p></aside> <aside><p>todo: for mobile, probably change to a drawer-from-bottom design</p></aside></section>",1);function Go(m,e){ft(e,!0);const P=Pe("Contextmenu");Nt.set(),Se(m,{get tome(){return P},children:(w,l)=>{var a=$o(),s=E(a);_n(s,{});var r=o(s,2);Zn(r,{});var x=o(r,2);yo(x,{});var A=o(x,2);uo(A,{});var T=o(A,2);go(T,{});var v=o(T,2);io(v,{});var d=o(v,2);Gn(d,{});var f=o(d,2);fn(f),$(2),n(w,a)},$$slots:{default:!0}}),xt()}export{Go as component};

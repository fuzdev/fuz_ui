...
import vite_plugin_well_known from '$routes/docs/vite_plugin_well_known/+page.svelte';
...
export const tomes: Array<Tome> = [
	...
	},
	{
		...
		category: 'helpers',
		Component: vite_plugin_well_known,
		related_tomes: ['api', 'LibraryDetail', 'LibrarySummary'],
		related_modules: ['vite_plugin_well_known.ts', 'library_gen.ts'],
		related_declarations: ['vite_plugin_well_known', 'library_gen'],
	},
	{
		name: 'mdz',
		category: 'helpers',
	...
	},
	{
		...
		related_tomes: ['api', 'logos', 'LibrarySummary', 'vite_plugin_well_known'],
		related_modules: [],
	...
	},
	{
		...
		related_tomes: ['api', 'logos', 'LibraryDetail', 'vite_plugin_well_known'],
		related_modules: [],

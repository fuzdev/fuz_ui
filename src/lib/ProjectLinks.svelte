<script lang="ts">
	...
	const project_items: Array<ProjectItem> = [
		...
		{name: 'fuz_css', url: 'https://css.fuz.dev/', logo: logo_fuz_css, description: 'CSS framework and design system', glyph: '🌿', color_class: 'palette_b_50'},
		{name: 'fuz_ui', url: 'https://ui.fuz.dev/', logo: logo_fuz_ui, description: 'Svelte UI library', glyph: '🧶', color_class: 'palette_c_50'},
		{name: 'fuz_template', url: 'https://template.fuz.dev/', logo: logo_fuz_template, description: 'a static web app and Node library template with TypeScript, Svelte, SvelteKit, Vite, esbuild, Fuz, and Gro', glyph: '❄', color_class: 'palette_h_50'},
		...
		{name: 'fuz_code', url: 'https://code.fuz.dev/', logo: logo_fuz_code, description: 'syntax styling utilities and components for TypeScript, Svelte, SvelteKit', glyph: '🎨', color_class: 'palette_g_50'},
		...
		{name: 'tsv', url: 'https://tsv.fuz.dev/', logo: logo_tsv, description: 'a parser and formatter for TypeScript and Svelte', glyph: '🪶', color_class: 'palette_h_50'},
	];
</script>

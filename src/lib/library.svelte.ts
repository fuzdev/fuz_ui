...
export class Library {
	 ...
	 */
	// Cast: fuz_util's SourceJson.modules type lacks alias_of.kind; svelte-docinfo's ModuleJson has it.
	// The runtime data includes kind (generated by svelte-docinfo). Safe to cast until fuz_util is updated.
	modules = $derived(
		this.source_json.modules
			? this.source_json.modules.map((module_json) => new Module(this, module_json as ModuleJson))
			: [],
	);
